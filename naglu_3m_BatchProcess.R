...
input <- here("naglu 3-month behaviour/Raw qwer files")
output <- here("naglu 3-month behaviour/")
...
setwd(output)
write.csv(df, "naglu_3m_tidy_data.csv")
...
setwd(output)
write.csv(df_a, "naglu_3m_time_in_zone.csv")
...
## STEP 7 - Final Output
setwd(output)
write.csv(final_data, "naglu_3m_final_output.csv")