...
input <- here("sgsh 3-month behaviour/")
output <- here("sgsh 3m/")
...
setwd(output)
write.csv(df, "sgsh_3m_tidy_data.csv")
...
setwd(output)
write.csv(df_a, "sgsh_3m_time_in_zone.csv")
...
## STEP 7 - Final Output
setwd(output)
write.csv(final_data, "sgsh_3m_final_output.csv")
